...
2. **`spec/runner.md`** — the `Runner` contract: lifecycle (load → request → export), state model, error and cancellation semantics. Promotes the sketch in [world.ts](../test-cases/step-defs/world.ts) to authoritative form.
...
## Definition of done
- Every symbol referenced in [test-cases/step-defs/](../test-cases/step-defs/) has a defining section in one of the four sub-docs.
